...
Este módulo contiene una copia del software de monitoreo y control pero con la diferencia que esta siendo ejecutado en la nube, usando los servicios de un servidor y un broker remoto.
