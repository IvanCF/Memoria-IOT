...
% La figura \ref{fig:diagrama2}  Muestra la lógica de funcionamiento del módulo de replicación.
...
El modulo principal (servidor local) tiene la capacidad de conectarse a la red vía Wi-Fi o vía Ethernet. La integración se visualiza en la figura \ref{fig:argon}.
