...
\caption{Pantalla gráfica del módulo con paso de la corriente eléctrica (led rojo indica peligro).}
...
\caption{Pantalla gráfica del módulo con bloqueo de la corriente eléctrica (led azul indica sin riesgo eléctrico).}
\label{fig:test-activa2}
\end{figure}

\vspace{0.5cm}

Para facilitar la comprensión de la interfaz gráfica, la figura \ref{fig:test-panel5} muestran las características del panel de visualización del módulo en el software cuando el actuador permite el paso de la corriente eléctrica.

\begin{figure}[htpb]
\centering 
\includegraphics[width=0.9\textwidth]{./Figures/test/consumo/panel5.png}
...
\begin{figure}[htpb]
\centering 
\includegraphics[width=0.85\textwidth]{./Figures/test/consumo/panel4.png}
